...
// Registrations returns a RegistrationInformer.
func (v *version) Registrations() RegistrationInformer {
	return &registrationInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
