...
var accessesResource = schema.GroupVersionResource{Group: "plugins.faros.sh", Version: "v1alpha1", Resource: "accesses"}

var accessesKind = schema.GroupVersionKind{Group: "plugins.faros.sh", Version: "v1alpha1", Kind: "Access"}
...
func (c *FakeAccesses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Access, err error) {
	...
	return obj.(*v1alpha1.Access), err
}
...
func (c *FakeAccesses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AccessList, err error) {
	...
	list := &v1alpha1.AccessList{ListMeta: obj.(*v1alpha1.AccessList).ListMeta}
	for _, item := range obj.(*v1alpha1.AccessList).Items {
