...
var containerruntimesResource = schema.GroupVersionResource{Group: "plugins.faros.sh", Version: "v1alpha1", Resource: "containerruntimes"}

var containerruntimesKind = schema.GroupVersionKind{Group: "plugins.faros.sh", Version: "v1alpha1", Kind: "ContainerRuntime"}
...
func (c *FakeContainerRuntimes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(containerruntimesResource, c.ns, name, opts), &v1alpha1.ContainerRuntime{})
