...
var requestsResource = schema.GroupVersionResource{Group: "access.faros.sh", Version: "v1alpha1", Resource: "requests"}

var requestsKind = schema.GroupVersionKind{Group: "access.faros.sh", Version: "v1alpha1", Kind: "Request"}
