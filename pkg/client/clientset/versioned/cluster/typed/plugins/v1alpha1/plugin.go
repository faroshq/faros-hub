...
// PluginsClusterGetter has a method to return a PluginClusterInterface.
// A group's cluster client should implement this interface.
type PluginsClusterGetter interface {
	Plugins() PluginClusterInterface
}
...
type pluginsClusterInterface struct {
