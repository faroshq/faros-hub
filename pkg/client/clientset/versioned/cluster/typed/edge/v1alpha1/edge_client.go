...
func (c *EdgeV1alpha1ClusterClient) Agents() AgentClusterInterface {
	return &agentsClusterInterface{clientCache: c.clientCache}
}

func (c *EdgeV1alpha1ClusterClient) Registrations() RegistrationClusterInterface {
	return &registrationsClusterInterface{clientCache: c.clientCache}
}
