...
var usersResource = schema.GroupVersionResource{Group: "tenancy.faros.sh", Version: "v1alpha1", Resource: "users"}
var usersKind = schema.GroupVersionKind{Group: "tenancy.faros.sh", Version: "v1alpha1", Kind: "User"}

type usersClusterClient struct {
	*kcptesting.Fake
}
...
// List takes label and field selectors, and returns the list of Users that match those selectors across all clusters.
func (c *usersClusterClient) List(ctx context.Context, opts metav1.ListOptions) (*tenancyv1alpha1.UserList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(usersResource, usersKind, logicalcluster.Wildcard, opts), &tenancyv1alpha1.UserList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &tenancyv1alpha1.UserList{ListMeta: obj.(*tenancyv1alpha1.UserList).ListMeta}
	for _, item := range obj.(*tenancyv1alpha1.UserList).Items {
...
// Watch returns a watch.Interface that watches the requested Users across all clusters.
func (c *usersClusterClient) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return c.Fake.InvokesWatch(kcptesting.NewRootWatchAction(usersResource, logicalcluster.Wildcard, opts))
}
...
func (c *usersClient) Create(ctx context.Context, user *tenancyv1alpha1.User, opts metav1.CreateOptions) (*tenancyv1alpha1.User, error) {
	...
	return obj.(*tenancyv1alpha1.User), err
}
