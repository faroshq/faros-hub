...
func (c *workspacesClusterClient) Cluster(clusterPath logicalcluster.Path) tenancyv1alpha1client.WorkspaceInterface {
...
func (c *workspacesClient) Create(ctx context.Context, workspace *tenancyv1alpha1.Workspace, opts metav1.CreateOptions) (*tenancyv1alpha1.Workspace, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootCreateAction(workspacesResource, c.ClusterPath, workspace), &tenancyv1alpha1.Workspace{})
	if obj == nil {
		return nil, err
	}
...
func (c *workspacesClient) Update(ctx context.Context, workspace *tenancyv1alpha1.Workspace, opts metav1.UpdateOptions) (*tenancyv1alpha1.Workspace, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateAction(workspacesResource, c.ClusterPath, workspace), &tenancyv1alpha1.Workspace{})
	if obj == nil {
		return nil, err
	}
	return obj.(*tenancyv1alpha1.Workspace), err
...
func (c *workspacesClient) UpdateStatus(ctx context.Context, workspace *tenancyv1alpha1.Workspace, opts metav1.UpdateOptions) (*tenancyv1alpha1.Workspace, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootUpdateSubresourceAction(workspacesResource, c.ClusterPath, "status", workspace), &tenancyv1alpha1.Workspace{})
	if obj == nil {
		return nil, err
	}
	return obj.(*tenancyv1alpha1.Workspace), err
...
func (c *workspacesClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	_, err := c.Fake.Invokes(kcptesting.NewRootDeleteActionWithOptions(workspacesResource, c.ClusterPath, name, opts), &tenancyv1alpha1.Workspace{})
	return err
}
...
func (c *workspacesClient) Get(ctx context.Context, name string, options metav1.GetOptions) (*tenancyv1alpha1.Workspace, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootGetAction(workspacesResource, c.ClusterPath, name), &tenancyv1alpha1.Workspace{})
	if obj == nil {
		return nil, err
	}
	return obj.(*tenancyv1alpha1.Workspace), err
...
func (c *workspacesClient) List(ctx context.Context, opts metav1.ListOptions) (*tenancyv1alpha1.WorkspaceList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(workspacesResource, workspacesKind, c.ClusterPath, opts), &tenancyv1alpha1.WorkspaceList{})
	if obj == nil {
		return nil, err
	}
...
func (c *workspacesClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (*tenancyv1alpha1.Workspace, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootPatchSubresourceAction(workspacesResource, c.ClusterPath, name, pt, data, subresources...), &tenancyv1alpha1.Workspace{})
	if obj == nil {
		return nil, err
	}
	return obj.(*tenancyv1alpha1.Workspace), err
