...
func (r *finalizerAddReconciler) reconcile(ctx context.Context, _ logicalcluster.Path, request *pluginsv1alpha1.Request) (reconcileStatus, error) {
...
func (r *finalizerRemoveReconciler) reconcile(ctx context.Context, _ logicalcluster.Path, request *pluginsv1alpha1.Request) (reconcileStatus, error) {
