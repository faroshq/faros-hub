...
func (r *finalizerAddReconciler) reconcile(ctx context.Context, _ logicalcluster.Path, binding *pluginsv1alpha1.Binding) (reconcileStatus, error) {
...
func (r *finalizerRemoveReconciler) reconcile(ctx context.Context, _ logicalcluster.Path, binding *pluginsv1alpha1.Binding) (reconcileStatus, error) {
