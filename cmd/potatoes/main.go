...
import (
	...
	"github.com/mjudeikis/kcp-example/pkg/controllers/potatoes/controller"
)
...
func init() {
	...
	utilruntime.Must(potatoesv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	options := ctrl.Options{
		...
		LeaderElectionID:       "68a0532d.faros.sh",
	...
	kubeClient, err := kubernetesclient.NewForConfig(restConfig)
	if err != nil {
		setupLog.Error(err, "failed to create kubernetes client: %w", err)
		os.Exit(1)
	}
	...
	if err = (&controller.Reconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "Potatoes")
		os.Exit(1)
	}
